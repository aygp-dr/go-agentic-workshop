...
type Metrics struct {
	...
	_ metric.Int64Counter // llmErrors

	// Workflow metrics - reserved for future use
	_ metric.Float64Histogram  // workflowDuration
	_ metric.Int64Counter      // workflowSteps
	_ metric.Int64UpDownCounter // activeWorkflows
}
